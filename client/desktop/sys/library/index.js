    ...
    return (
      <div className={`${style.page} g-ctn`}>
        <div className={style.list}>
          ...
          <a className={style.link} target="_blank" rel="noopener noreferrer" href="https://fegos.github.io/react-native-template-fego/">
            <img src={require('../home/img/wifi.jpg')} alt="fego" />
            <p className={style.title}>Fego-RN-Template</p>
          </a>
          <a className={style.link} target="_blank" rel="noopener noreferrer" href="https://fegos.github.io/fego-rn-update/">
            <img src={require('../home/img/wifi.jpg')} alt="fego" />
