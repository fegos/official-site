...
let mobileConfig, serverConfig, cdnPath = '/cdn/mob/'
...
mobileConfig = {
	...
	output: {
		path: path.resolve(BUILD_PATH, 'mob'),
		publicPath: cdnPath,
	...
	plugins: [
		...
		new HtmlWebpackPlugin({
			filename: path.resolve(ROOT_PATH, 'server/views/mobile.html'),
			template: path.resolve(ROOT_PATH, 'views/mobile.tpl.html')
		})
	],
...
serverConfig = {
	...
	output: {
		path: path.resolve(ROOT_PATH, 'server/client/mobile'),
		publicPath: cdnPath,
		filename: '[name].js',
